...
SessionManagementScreen {
    ...
    RowLayout {
        ...
        PlasmaComponents.Button {
                    ...
                    Accessible.name: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Suspend")
        ...
        PlasmaComponents.Button {
                    ...
                    Accessible.name: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Reboot")
        ...
        PlasmaComponents.Button {
                    ...
                    Accessible.name: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Shutdown")
